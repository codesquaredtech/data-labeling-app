...
import { clearState as clearProjectState, projectsSliceSelectors } from "../../../../slices/Projects/projectsSlice";
      ...
      return [
        {
          ...
          Cell: ({ row }: CellValue) => (
            <span className="flex justify-start gap-2">
              <button className="btn btn-circle btn-warning" onClick={() => handleEditMetadata(row.original._id)}>
                <svg
              ...
              <button className="btn btn-circle btn-error" onClick={() => handleOpenDeleteModal(row.original._id)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
