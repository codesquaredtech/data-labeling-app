            ...
            <div className="card w-5/12 bg-neutral text-neutral-content">
                {isLoading ? (
                    ...
                    <div className="card-body text-center items-center">
                        <div
                            className="divider mb-6 before:bg-gradient-to-r before:from-primary after:bg-gradient-to-l after:from-primary">
                        ...
                        {user ? (
                            ...
                            <div className="mt-6">
                                An error has occurred fetching your data. Please reload and try again.
                            </div>
                        )}
                    </div>
                )}
