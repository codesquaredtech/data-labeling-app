        ...
        <ul ref={drawerRef} className="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content">
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none">
              <svg className="w-4 h-4 stroke-current text-neutral-content" fill="none" viewBox="0 0 24 24">
                <path
                  stroke="currentColor"
                  strokeLinecap="round"
          ...
          <div className="p-4 -m-6 bg-base-300 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="flex flex-col pl-3">
                ...
                <span className="text-xs text-base-content opacity-60 font-light tracking-tight">{email || "N/A"}</span>
              </div>
            </div>
          </div>
        </ul>
